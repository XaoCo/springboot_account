...
//     对于开启了独立密码的邮箱, 这里的邮箱密码必需使用这个独立密码（授权码）。
    public static String account = "17600201849@163.com";
    public static String password = "wy111111.c";
...
// 3.3设置邮件的主题
            message.setSubject("来自我的小窝的激活邮件");
// 3.4设置邮件的正文
//message.setContent("<h1>来自智慧电梯的激活邮件，您的验证码是：</h1><h3><a href='http://localhost:10080/Demo_JavaMail/active?code=" + code + "'>http://localhost:10080/Demo_JavaMail/active?code=" + code + "</h3>", "text/html;charset=UTF-8");
            message.setContent("<h1>来自我的小窝的激活邮件，您的验证码是：" + code, "text/html;charset=UTF-8");
// 4.发送邮件
...
//mailUtil.sendMail("17090853226@163.com", "樊霞霞是个三傻子");//接收方  接受码

        mailUtil.sendMail("ysullz1990@163.com", random);//接收方  接受码
